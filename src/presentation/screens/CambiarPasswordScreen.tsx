  ...
  const handleSubmit = async () => {
    ...
    try {
      await cambiarPassword(
        identificador,
        passwordTemporal ? null : passwordActual,
        passwordNueva,
      );
      setOk(true);
      onSuccess?.();
      ...
      >
        ...
        <SectionCard style={styles.card}>
          ...
          <Text style={styles.subtitle}>
            {passwordTemporal
              ? "Se creó automaticamente tu cuenta, para administrar tus reportes define una contraseña nueva por favor."
          ...
          <View style={styles.form}>
              ...
              <>
                ...
                <View
                  style={[
                    ...
                    actualFocused && styles.inputContainerFocused,
                  ]}
                >
                  <Icon
                    name="Lock"
                    size={18}
                    color={
                      actualFocused ? theme.colors.red : theme.colors.textMuted
                    }
            ...
            <View
              style={[
                styles.inputContainer,
                nuevaFocused && styles.inputContainerFocused,
              ]}
            >
              <Icon
                name="Lock"
            ...
            >
              <Icon
                ...
                size={18}
                color={
                  confirmarFocused ? theme.colors.red : theme.colors.textMuted
                }
                style={styles.inputIcon}
              />
              <TextInput
