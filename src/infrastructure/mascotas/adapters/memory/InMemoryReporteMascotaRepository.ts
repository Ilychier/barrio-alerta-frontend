...
export class InMemoryReporteMascotaRepository implements IReporteMascotaRepository {
  ...
  constructor() {
    this.reportes = [
      new ReporteMascota(1, TipoReporte.LOST, 1, 1, 'Barrio La Soledad, cerca al parque', '+573173784522', 'Perro criollo, collar rojo, responde al nombre Toby', EstadoReporte.ACTIVE, '2026-08-10T09:30:00', '2026-08-10T09:30:00', 32),
      new ReporteMascota(2, TipoReporte.FOUND, 1, 1, 'Calle 5 con carrera 10, junto al CAI', '+573173784522', 'Perro adulto color miel, sin collar', EstadoReporte.ACTIVE, '2026-08-10T11:00:00', '2026-08-10T11:00:00', 502),
      new ReporteMascota(3, TipoReporte.LOST, 2, 1, 'Conjunto Villa del Prado, torre 3', '+573173784522', 'Gata negra de ojos verdes, esterilizada', EstadoReporte.RESCUED, '2026-08-09T14:00:00', '2026-08-10T08:00:00', 32),
      new ReporteMascota(4, TipoReporte.FOUND, 2, 1, 'Parque Central, banca junto al kiosco', '+573173784522', 'Gato gris atigrado, muy manso', EstadoReporte.RESCUED, '2026-08-08T16:30:00', '2026-08-09T10:00:00', 502),
      new ReporteMascota(5, TipoReporte.LOST, 1, 2, 'El Poblado, avenida Las Vegas', '+573173784522', 'Golden retriever, collar azul', EstadoReporte.ACTIVE, '2026-08-11T07:00:00', '2026-08-11T07:00:00', 32),
    ];
  }
